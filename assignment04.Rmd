...
ggplot(mapping=(aes(x="", y = percent_poverty, fill = category))) + 
  ...
  theme_void() + 
  geom_text(aes(y = percent_poverty, label = category ) , color ="white", size = 4)
  
  #The United States is rampant with poverty and income inequality. This simple, but effective, pie chart shows percent poverty based off of regions in the United States in 2019. The West and the Midwest have the highest percentages of poverty in the United States. Historically, that remains true. Both the Midwest and the West are agriculturally heavy regions that rely on cash crops and agricultural subsidies from the government. Subsequently, both the Northeast and more recently the South are known as business conducive cities. Large metropolitan cities like NYC, Boston, Stamford, Philadelphia, Atlanta. etc. all provide more professional services and in turn more and diverse job prospects. 
